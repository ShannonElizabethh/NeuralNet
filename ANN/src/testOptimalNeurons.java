...
public class testOptimalNeurons {
	...
	public static void main(String[] args) throws IOException, ParseException, org.json.simple.parser.ParseException {
		...
		boolean fullyConnectedNet = true;
		
		long programTimer = System.nanoTime();
		
		//initalize net
		NeuralNet net = new NeuralNet();
		net = net.initalizeNet(15, 5, 4);
		
		//find optimal number of neurons
		net = getOptimalNeurons(net, fullyConnectedNet);
...
//		Data.NormalizationTypesENUM NORMALIZATION_TYPE = Data.NormalizationTypesENUM.MAX_MIN_EQUALIZED; 
	...
	public static NeuralNet getOptimalNeurons(NeuralNet net, boolean fullyConnectedNet) throws IOException, ParseException, org.json.simple.parser.ParseException {
...
//		if (savedWeights == true) {
			...
			removeNeurons(net, accuracy, 0.2, fullyConnectedNet);			
			...
			if(numNeuron >= 10) {
				removeNeurons(net2, accuracy, 0.1, fullyConnectedNet);
				net2 = NetFunctions.readJSONFile(fileName);
			}
/*			
...
*/
	...
	public static void removeNeurons(NeuralNet net, double accuracy, double percent, boolean fullyConnectedNet) throws IOException {
		Data fileName  = new Data("JSONFiles", "testJSON.json");
